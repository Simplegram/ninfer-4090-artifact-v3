...
1. **v3 artifact format, end to end** (`37598370`)
   ...
   - The v3 reference itself (framing, schema, format registry, container tooling) is taken directly from the original [Neroued/ninfer](https://github.com/Neroued/ninfer) upstream and specialized for this target's closed registry — it is not a local reinvention of the format.
